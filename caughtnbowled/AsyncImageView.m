...
- (void)start
{
    ...
    NSString *thatPath = [[NSBundle mainBundle] pathForResource:@"keys" ofType:@"plist"];
    
//    NSDictionary *keysDict = [NSDictionary dictionaryWithContentsOfFile:@"keys.plist"];
    
    NSDictionary *keysDict = [[NSDictionary alloc] initWithContentsOfFile:thatPath];
    NSString *xmashapekey = [keysDict objectForKey:@"X-Mashape-Key"];
    
    

    [request addValue:xmashapekey forHTTPHeaderField:@"X-Mashape-Key"];
